function navbar() {
  ...
  <a style="margin-left: 27px;cursor:pointer;" href="home.html" class="logo"><img src="https://cdn.freelogovectors.net/wp-content/uploads/2021/02/myntra-logo-freelogovectors.net_.png" alt=""></a>
<nav>
  <ul class="menu-items">
    <!-- Link to Fashion Shows Page -->
      <div class="fashion-shows-link">
        <a href="index.html"><b>Fashion Shows</b></a>
      </div>
    <li>
