...
const displayData = () => {
  ...
  Right.innerHTML = ` <h3 class="poductName">${product.brand}</h3>
    ...
    <div class="goGreenContainer">
        <input type="checkbox" id="goGreenCheckbox" />
        <label for="goGreenCheckbox">GoGreen</label>
        <a href="goGreen.html" target="_blank">Know more about GoGreen</a>
    </div>
    <hr>
    <div>
      <a href="virtualTry.html" target="_blank">Virtual Try On</a>
    </div>
    <hr>
    <div id="Buttons">
